...
```{r}
# In-sample MSE
sprintf("In-sample MSE is %f",mean((sGARCH_pls@fit$residuals*sd(R_train))^2))
```
...
sprintf("Out-of-sample MSE is %f",mean(((t(fitted_sGARCH_pls)-R_pls[(length(R_pls)-N_test):length(R_pls)])*sd(R_train))^2))
sprintf("Out-of-sample mean of sd is %f",mean(sigma_sGARCH_pls))
```
